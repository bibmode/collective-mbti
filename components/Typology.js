      ...
      <div className="mb-3 flex justify-center">
        <div>
          <input
            ...
            type="radio"
            name="typology-navbar"
            id="typology-4Letters"
            defaultChecked
      ...
      <div className="flex items-end py-3">
        ...
        <div className="mr-4">
          <input
            ...
            onChange={(e) => {
              if (e.target.checked) {
                document.getElementById(`likes-${index}-2`).checked = false;
              }
            }}
          />

          <label
            className="flex peer-checked:text-orange-500"
            htmlFor={`likes-${index}-1`}
          >
        ...
        <div className="flex-1">
          <input
            ...
            onChange={(e) => {
              if (e.target.checked) {
                document.getElementById(`likes-${index}-1`).checked = false;
              }
            }}
          />
          ...
          <label
            className="flex peer-checked:text-orange-500"
            htmlFor={`likes-${index}-2`}
          >
            <p className="mr-1">2</p>
            <Icon className="text-lg mt-0.5" icon="ant-design:dislike-filled" />
          </label>
        </div>
